...
#21..40 | % -Process { Set-Content -Path $TestSource\$_.txt -Value ('B'*(Get-Random -Minimum 950 -Maximum 1400)); };

# 5. Call the Copy-WithProgress function (again)
#Copy-WithProgress -Source $TestSource -Destination $TestTarget -Verbose;
# Copy-WithProgress -Source D:\Ca200\archive\"  -Destination "C:\progetti\Aladdin\UpgradeTool\..\Backup\34534534\archive\" -Verbose;